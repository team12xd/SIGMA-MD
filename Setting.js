...
global.mztit = process.env.MZTIT ||"➳ᴹᴿ᭄𝑾𝑨𝑻𝑺𝑶𝑵-𝑿𝑫 ࿌𒆜༒",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@InnoxentTech?sub_confirmation=1' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/915d08675cb62bf1eb1ca.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '➳ᴹᴿ᭄𝑾𝑨𝑻𝑺𝑶𝑵-𝑿𝑫 ࿌𒆜༒',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `➳ᴹᴿ᭄𝑾𝑨𝑻𝑺𝑶𝑵-𝑿𝑫 ࿌𒆜༒`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'https://telegra.ph/file/915d08675cb62bf1eb1ca.jpg',      // ADD YOUR STICKER AUTHOR NAME
